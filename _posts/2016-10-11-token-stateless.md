...
Espero tomarle el gusto a esto del blog, y seguir aportando con experiencias día a día.
...
Hasta aquí llega este post, como podemos ver, siempre hay soluciones para no usar session (¡NO USES SESSION!).
